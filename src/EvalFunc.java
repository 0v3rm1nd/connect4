...
public class EvalFunc {
    ...
    public static int countDiagonalRight(int[][] state, int[][] scoreBoard, int col, int row, int player, int x) {
        int currentRow = row;
    ...
    public static int countDiagonalLeft(int[][] state, int[][] scoreBoard, int col, int row, int player) {
        int currentRow = row;
        int currentColumn = col;
        int score = 0;
        int distance = 0;
    ...
    public static int countVertical(int[][] state, int[][] scoreBoard, int col, int player, int y) {
        int score = 0;
        int distance = 0;
        int connected = 0;
    ...
    public static int countHorizontal(int[][] state, int[][] scoreBoard, int row, int player, int y) {
        int score = 0;
        int distance = 0;
        int connected = 0;
